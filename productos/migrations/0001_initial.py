    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcompra', models.DecimalField(max_digits=20, decimal_places=2)),
                ('pventa', models.DecimalField(max_digits=20, decimal_places=2)),
                ('cantidad', models.PositiveIntegerField()),
                ('pro_compra', models.OneToOneField(to='proveedores.Proveedor')),
            ],
        ),
    ]
